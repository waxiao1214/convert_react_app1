    ...
    <div className={ styles.scene_8_container }>
        <div className = "row">
          <div className = "userml">
            <div className = "col-12 col-md-6" style={{maxWidth:'530px'}} >
              <img src = { scene8_phone } style = {{ width : '461px'}}/>
            </div>
            <div className = "col-12 col-md-6">
              <div className = { styles.Scene8_right}>
                ...
                <p style={{textShadow:'0px 9px 9px rgba(0, 0, 0, 0.25)', fontSize:'20px', color:'#FF3A44'}}>
